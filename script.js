...
function renderRFControls(host) {
  ...
  dateGrp.appendChild(createToggleRow("Update Date Line", appState.workingMode ? "Working-days wording" : "Exact-date wording", s.updateDate, val => { s.updateDate = val; updatePreview(); }));
